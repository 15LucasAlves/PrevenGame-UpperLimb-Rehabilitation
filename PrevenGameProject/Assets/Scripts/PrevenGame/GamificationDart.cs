...
public class GamificationDart : MonoBehaviour
{
    ...
    /// <summary>
    /// Lança o dardo em linha reta até <paramref name="destino"/> e crava-o lá.
    /// <paramref name="aoChegar"/> é invocado quando o dardo crava (chega ao alvo).
    /// </summary>
    ...
    IEnumerator Voar(Vector3 destino, Transform paiAlvo, System.Action aoChegar)
    {
        ...
        aoChegar?.Invoke(); // pontuação só agora — o dardo chegou ao alvo
    }
}
